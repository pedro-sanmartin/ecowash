...
@Component({
  selector: 'app-ultimos-movimientos-operador',
  templateUrl: './ultimos-movimientos-operador.component.html',
  styleUrls: ['./ultimos-movimientos-operador.component.css']
})
export class UltimosMovimientosOperadorComponent implements OnInit {
